    ...
    try {
        if (String(contentType).toLowerCase() == 'application/json') {
            ...
            if (dadosMedico.nome == '' || dadosMedico.nome == undefined || dadosMedico.nome == null || 
                ...
                if (dadosMedico.pos_graduacao != null &&
                    dadosMedico.pos_graduacao != '' &&
                    dadosMedico.pos_graduacao != undefined) {
    ...
    if (String(contentType).toLowerCase() == 'application/json') {
        ...
        if (id == '' || id == undefined || id == isNaN(id) || id == null) {
            ...
            dadoAtualizado.telefone.length > 12
                ...
                if (dadoAtualizado.pos_graduacao != null &&
                    dadoAtualizado.pos_graduacao != '' &&
                    dadoAtualizado.pos_graduacao != undefined) {
